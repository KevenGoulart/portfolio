...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-yellow-300/50 to-purple-900/50 backdrop-blur-md p-5 flex justify-between items-center mx-auto max-w-[95%] md:max-w-[70%] rounded-[30px] mt-1 md:mt-4 md:px-20">
